...
module.exports = async (req, res, next) => {
    ...
    try {
        ...
        if (!user.is_verified) {
            // Jika pengguna belum terverifikasi, berikan respons atau arahkan kembali ke halaman verifikasi
            return res.status(401).send({ message: "Unauthorized - Email belum diverifikasi." });
        }
